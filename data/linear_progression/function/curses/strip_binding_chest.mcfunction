...
execute at @s positioned ~ 320 ~ run item replace entity @e[type=item,tag=lp_bind_strip,distance=..1,limit=1] contents from entity @s armor.chest
...
execute at @s positioned ~ 320 ~ run item replace entity @s armor.chest from entity @e[type=item,tag=lp_bind_strip,distance=..1,limit=1] contents
