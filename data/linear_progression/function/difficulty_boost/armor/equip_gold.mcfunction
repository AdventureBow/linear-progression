# Gold — plain or trimmed (random pattern + weighted material).
...
execute if score @s equip_piece matches 1 run item replace entity @s armor.head with golden_helmet
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim slot set value "armor.head"
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim item set value "minecraft:golden_helmet"
...
execute if score @s equip_piece matches 1 run item replace entity @s armor.chest with golden_chestplate
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim slot set value "armor.chest"
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim item set value "minecraft:golden_chestplate"
execute if score @s equip_piece matches 2 run function linear_progression:difficulty_boost/trim/apply with storage linear_progression:trim
...
execute if predicate linear_progression:rarity/half run scoreboard players set @s equip_piece 1
execute if score @s trim_chance matches 1.. if predicate linear_progression:rarity/common run scoreboard players set @s equip_piece 2
execute if score @s equip_piece matches 1 run item replace entity @s armor.legs with golden_leggings
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim slot set value "armor.legs"
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim item set value "minecraft:golden_leggings"
execute if score @s equip_piece matches 2 run function linear_progression:difficulty_boost/trim/apply with storage linear_progression:trim
...
execute if predicate linear_progression:rarity/common run scoreboard players set @s equip_piece 1
execute if score @s trim_chance matches 1.. if predicate linear_progression:rarity/common run scoreboard players set @s equip_piece 2
execute if score @s equip_piece matches 1 run item replace entity @s armor.feet with golden_boots
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim slot set value "armor.feet"
execute if score @s equip_piece matches 2 run data modify storage linear_progression:trim item set value "minecraft:golden_boots"
execute if score @s equip_piece matches 2 run function linear_progression:difficulty_boost/trim/apply with storage linear_progression:trim
